 ...
 */
public class GrupoDAO extends BaseHibernateDAO {
	...
	public Grupo findById(java.lang.Integer id) {
		log.debug("getting Grupo instance with id: " + id);
		try {
			Grupo instance = (Grupo) getSession().get("hibernate.Grupo", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Grupo instance) {
		...
		try {
			List results = getSession().createCriteria("hibernate.Grupo")
